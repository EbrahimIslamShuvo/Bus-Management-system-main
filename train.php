  ...
  <section>
      <div class="mt-20 w-full bg-[#eaf9e7] flex flex-col gap-t-10 ">
        <div class="text-5xl  rounded-full flex items-center justify-center text-center my-3  py-5">
          <marquee scrollamount="10" class="bg-[#3FC495] w-[80%] py-3 rounded-full h-auto">This service not available now</marquee>
        </div>
        <div>
          ...
          <div class="flex items-center justify-center">
            <form class="my-20 w-full flex flex-col gap-5 items-center justify-center">
              ...
              <div class="w-2/4 flex items-center justify-center bg-[#3fc49a] cursor-pointer hover:bg-[#3fc495f2] pl-5 px-3 py-2 border-none transition-all ease-in">
              <input class="text-white text-xl font-semibold transition-all ease-in-out cursor-pointer" type="submit" value="Search" disabled/>
              </div>
            </form>
          </div>
        </div>
