  ...
  <section class="mt-20">
    ...
    <div class="flex flex-col border-none rounded-lg bg-[#188a62] lg:items-center">
        <img class="rounded-t-lg"
          src="https://i.ibb.co/mG97Q39/thumb65a0d5cb76d1a.jpg"
    ...
    <div class="grid lg:grid-cols-3 md:grid-cols-2 gap-4 md:mx-28 mx-[5%] pt-8 mb-10">
      ...
      <div class="flex flex-col border-none rounded-lg bg-[#188a62] lg:items-center">
        <img class="rounded-t-lg"
          src="https://i.ibb.co/p2ry6SC/BANGLADESH-DENIM-EXPO-NOVEMBER-2022-2-1536x806.png"
      ...
      <div class="flex flex-col border-none rounded-lg bg-[#188a62] lg:items-center">
        <img class="rounded-t-lg" src="https://i.ibb.co/fGF7Trv/4adff7d4c3ec3ff65fde253bfc08229c962d4c0de71cbb8c462383f734e15d93-rimg-w960-h503-gmir.jpg"
          alt="BANGLADESH-DENIM-EXPO-NOVEMBER-2022-2-1" />
        <p class="py-3 text-center text-white text-2xl font-bold">
